...
như vậy, pipeline parse sẽ như sau (đây là thứ tự):
 ...
 + chuẩn hóa phần vần
  * tách âm đệm (phần còn lại bên trái), âm chính (parse đầu tiên để đảm bảo nguyên atomic), âm cuối (phần còn lại bên phải). lưu ý trường hợp: "ui" thì "u" là âm chính và âm cuối "i", trong khi "uy" thì "y" là âm chính và "u" là âm đệm
